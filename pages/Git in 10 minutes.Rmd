...
You are said to **"pull"** when bring (**"fetch"**) a file from git repo into your **working directory/file** which is simply single checkout of one version of the project. These files are pulled out of the compressed database in the Git directory and placed on disk for you to use or modify. Pull will **fetch the changes and merge** it into a local branch of the same name.
